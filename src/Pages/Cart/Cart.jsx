...
const Cart = () => {
  ...
  if(!carts.length) {
    return (<div className="min-h-[950px] my-40 ">
        <div className="text-center text-red-500 text-3xl border border-red-500 p-36">
          There is no cart
        </div>
                        ...
                        <td className="py-4">
                          ...
                          <div className="modal" role="dialog">
                            <div className="modal-box">
                              <p className="py-4">Do you wanna remove it?</p>
                              <div className="modal-action">
                                <label onClick={() => handleRemove(cart?.id)} htmlFor="my_modal_6" className="btn bg-red-500 text-white hover:bg-red-500">Remove</label>
